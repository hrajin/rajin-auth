        ...
        <div class="flex items-center justify-between">
            <label for="remember_me" class="inline-flex items-center gap-2 cursor-pointer">
                <input
                    id="remember_me"
                    type="checkbox"
                    class="w-4 h-4 rounded border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:checked:bg-indigo-500 text-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-400 dark:focus:ring-offset-gray-900"
                    name="remember"
                />
